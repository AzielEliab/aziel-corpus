...
keywords: "aziel-dossier-1.0, Apache-2.0, foldlock, software, zion:not_applicable"
zion_pattern: not_applicable
identity: Aziel Eliab
person_id: https://www.azieleliab.com/#aziel
runtime_id: https://www.azieleliab.com/runtime#runtime
filename: foldlock-aziel-dossier-1.0.md
---
# FoldLock — Aziel dossier

**Author:** Aziel Eliab
**Version:** 1.0 (product 0.8.0)
**Date:** 2026-09-12
**Slug:** `foldlock`
...
Zip-class SOTA adaptive UNI1 compression engine on UTF-8 text.
...
- **Home:** https://foldlock-download-tracker.vibelock.workers.dev/
...
- **fraggate/describe:** https://aziel-runtime.vibelock.workers.dev/v1/fraggate/describe?slug=foldlock
