...
slug: forgereceipts
kind: software
title: ForgeReceipts — Aziel dossier
author: Aziel Eliab
version: "1.0"
...
subjects: forgereceipts aziel dossier
keywords: "aziel-dossier-1.0, Apache-2.0, forgereceipts, software, zion:not_applicable"
zion_pattern: not_applicable
identity: Aziel Eliab
person_id: https://www.azieleliab.com/#aziel
runtime_id: https://www.azieleliab.com/runtime#runtime
filename: forgereceipts-aziel-dossier-1.0.md
---
# ForgeReceipts — Aziel dossier
...
Local receipt mint + verify / import_export. Not legal advice. Does not contact courts.
...
- **Home:** https://forgereceipts-download-tracker.vibelock.workers.dev/
- **GitHub:** https://github.com/AzielEliab/forgereceipts
- **Counted /download:** https://forgereceipts-download-tracker.vibelock.workers.dev/download
- **MCP:** https://aziel-runtime.vibelock.workers.dev/mcp
- **fraggate/describe:** https://aziel-runtime.vibelock.workers.dev/v1/fraggate/describe?slug=forgereceipts
