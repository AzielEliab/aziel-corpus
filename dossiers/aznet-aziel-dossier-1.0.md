...
subjects: aznet aziel dossier
keywords: "aziel-dossier-1.0, Apache-2.0, aznet, software, zion:not_applicable"
zion_pattern: not_applicable
identity: Aziel Eliab
person_id: https://www.azieleliab.com/#aziel
runtime_id: https://www.azieleliab.com/runtime#runtime
filename: aznet-aziel-dossier-1.0.md
---
# AZNet — Aziel dossier
...
AZNet (AZN-WP-0.1): silent verification side-net. Hash continuity without hosting. Separate software; functional-order pair with AZBrowser.

### What it is

AZNet (AZN-WP-0.1): silent verification side-net. Hash continuity without hosting. Separate software; functional-order pair with AZBrowser.

Catalog domain label: **Network**.
engine_digest: `eb02566041f2fa48f9b49be359732737860382052666de7df1062baf808e7d88`.
...
- **Home:** https://aznet-download-tracker.vibelock.workers.dev/
- **GitHub:** https://github.com/AzielEliab/aznet
- **Counted /download:** https://aznet-download-tracker.vibelock.workers.dev/download
- **MCP:** https://aziel-runtime.vibelock.workers.dev/mcp
- **fraggate/describe:** https://aziel-runtime.vibelock.workers.dev/v1/fraggate/describe?slug=aznet
