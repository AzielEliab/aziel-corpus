...
subjects: azclce aziel dossier
keywords: "aziel-dossier-1.0, Apache-2.0, azclce, software, zion:not_applicable"
zion_pattern: not_applicable
identity: Aziel Eliab
person_id: https://www.azieleliab.com/#aziel
runtime_id: https://www.azieleliab.com/runtime#runtime
filename: azclce-aziel-dossier-1.0.md
---
# AZ-CLCE — Aziel dossier
...
Jaccard triple / pairwise / CLCE+. Detects inconsistency, not intent. AZCoherence is a separate peer reviewer.

### What it is

Jaccard triple / pairwise / CLCE+. Detects inconsistency, not intent. AZCoherence is a separate peer reviewer.

Catalog domain label: **Language**.
...
- **Home:** https://azclce-download-tracker.vibelock.workers.dev/
- **GitHub:** https://github.com/AzielEliab/az-clce
- **Counted /download:** https://azclce-download-tracker.vibelock.workers.dev/download
- **MCP:** https://aziel-runtime.vibelock.workers.dev/mcp
- **fraggate/describe:** https://aziel-runtime.vibelock.workers.dev/v1/fraggate/describe?slug=azclce
