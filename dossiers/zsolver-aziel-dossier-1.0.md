...
slug: zsolver
kind: software
title: ZionPattern Solver — Aziel dossier
author: Aziel Eliab
version: "1.0"
...
subjects: zsolver aziel dossier
keywords: "aziel-dossier-1.0, Apache-2.0, zsolver, software, zion:not_applicable"
zion_pattern: not_applicable
identity: Aziel Eliab
person_id: https://www.azieleliab.com/#aziel
runtime_id: https://www.azieleliab.com/runtime#runtime
filename: zsolver-aziel-dossier-1.0.md
---
# ZionPattern Solver — Aziel dossier
...
- **Home:** https://zsolver-download-tracker.vibelock.workers.dev/
- **GitHub:** https://github.com/AzielEliab/zion-pattern-solver
- **Counted /download:** https://zsolver-download-tracker.vibelock.workers.dev/download
- **MCP:** https://aziel-runtime.vibelock.workers.dev/mcp
- **fraggate/describe:** https://aziel-runtime.vibelock.workers.dev/v1/fraggate/describe?slug=zsolver
