...
subjects: vibelock aziel dossier
keywords: "aziel-dossier-1.0, Apache-2.0, vibelock, software, zion:not_applicable"
zion_pattern: not_applicable
identity: Aziel Eliab
person_id: https://www.azieleliab.com/#aziel
runtime_id: https://www.azieleliab.com/runtime#runtime
filename: vibelock-aziel-dossier-1.0.md
---
# VibeLock — Aziel dossier
...
Physics + A/V deepfake risk assessment. Not a lie detector and not courtroom proof.
...
- **Home:** https://vibelock-download-tracker.vibelock.workers.dev/
- **GitHub:** https://github.com/AzielEliab/vibelock
- **Counted /download:** https://vibelock-download-tracker.vibelock.workers.dev/download
- **MCP:** https://aziel-runtime.vibelock.workers.dev/mcp
- **fraggate/describe:** https://aziel-runtime.vibelock.workers.dev/v1/fraggate/describe?slug=vibelock
