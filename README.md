...
- **Softwares:** [https://www.azielcorpuslibrary.net/software](https://www.azielcorpuslibrary.net/software) — library Softwares catalog for aziel-runtime (Worker `GET /v1/software` is SSoT; `GET /runtime/v1/fraggate/list` is fallback only). Heading then list. No fixed product cap. Do not mash version + FragGate into Softwares copy.
