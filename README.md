...
- **Aziel Runtime (this domain):** [https://www.azielcorpuslibrary.net/runtime](https://www.azielcorpuslibrary.net/runtime) — Aziel Runtime **2.0.0-rc1** (SoT LIVE `main` `6a3798a` / version_id `105fa1ee`). FragGate is the single door (`fraggate_list` → `fraggate_describe` → `fraggate_call`). MCP Softwares via `fraggate_call` only. Prefer `/runtime/*`. Runtime `@id` [https://www.azieleliab.com/runtime#runtime](https://www.azieleliab.com/runtime#runtime)
