...
def main():
    ...
    bf=sub.add_parser('backfill-review'); bf.add_argument('--limit',type=int,default=50); bf.add_argument('--force',action='store_true'); bf.add_argument('--record-id',default='')
    ...
    elif a.cmd=='backfill-review': print(json.dumps(v.backfill_reviews(limit=a.limit,force=a.force,record_id=a.record_id or None),indent=2,default=str))
