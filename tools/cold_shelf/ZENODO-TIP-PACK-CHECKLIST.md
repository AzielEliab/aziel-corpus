# Zenodo tip-pack — SLOT (not Plane B working shelf)
...
Zenodo is **not** the Plane B working shelf. Status is **slot** with `zenodo_live:false` and `doi` null (`CNS-ZENODO-NOT-LIVE`, `CNS-NO-TIP-DOI`). Do not invent a tip-pack DOI.
...
Refuse codes: `CNS-ZENODO-NOT-LIVE` · `CNS-NO-TIP-DOI` · `CNS-TIP-NOT-ON-DEPOSIT` · `CNS-NO-FAN-FAKE-DEPOSIT`
