...
- GET /shelves · /cold-copy · /v1/shelves  COLD-MULTI-SHELF-1.0 planes A/B/C (A = one CF/GitHub tunnel, 5 surfaces / 2 family radii; B = alt independent forge/archive tip-pack SLOT, LIVE only Codeberg+archive.org+Framagit; Zenodo refused CNS-ZENODO-IP-BAN; GitFlic SLOT CNS-GITFLIC-EMAIL; C = USB airgap SLOT + RESTORE-DRILL schema). Extra D/E/F SLOTs (Launchpad, AfricArXiv/OSF, GitLab CNS-GITLAB-CF-LOOP) stay url-null. Honest live|slot|refused. FoldLock neighbor cite + SLOT hook (FOLDLOCK-SHELF-1.0): not zip, not encryption; never fold the lockset tip. No invented CIDs or tip DOI. Not AZ-GEN live ICANN publish.
