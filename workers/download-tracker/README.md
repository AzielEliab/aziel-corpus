...
- GET /shelves · /cold-copy · /v1/shelves  COLD-MULTI-SHELF-1.0 honest registry (live|slot|refused) + verify how-to. No invented CIDs. Lockset DOI stays null. Not AZ-GEN live ICANN publish.
