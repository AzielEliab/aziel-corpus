...
- GET /shelves · /cold-copy · /v1/shelves  COLD-MULTI-SHELF-1.0 planes A/B/C (A = one CF/GitHub tunnel; B = Zenodo tip-pack SLOT; C = USB airgap SLOT). Honest live|slot|refused. No invented CIDs or tip DOI. Not AZ-GEN live ICANN publish.
