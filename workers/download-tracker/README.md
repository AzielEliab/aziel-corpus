...
- GET /shelves · /cold-copy · /v1/shelves  COLD-MULTI-SHELF-1.0 planes A/B/C (A = one CF/GitHub tunnel, 5 surfaces / 2 family radii; B = alt independent forge/archive tip-pack SLOT — Codeberg + archive.org PASS, third Framagit OR GitLab; GitFlic optional CNS-GITFLIC-EMAIL; Zenodo refused CNS-ZENODO-IP-BAN; C = USB airgap SLOT). Honest live|slot|refused. No invented CIDs or tip DOI. Not AZ-GEN live ICANN publish.
