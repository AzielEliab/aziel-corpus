...
export function llmsDoc(limitation) {
  return "# Aziel Digital Library v2.7.0\n\n"
    ...
    + "- Visible lock under H1: " + LOCK_LINE + "\n"
    + "- Who HTML: " + HOST + WHO_PATH + "\n"
