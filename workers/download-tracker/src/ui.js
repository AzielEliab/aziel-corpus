...
<li><a href="/runtime/v1/mesh"><code>/runtime/v1/mesh</code></a> · <a href="/v1/mesh"><code>/v1/mesh</code></a> — suite Live Nodes / mesh status (read-only QNM ON; counts/status rollup, not the cell; cold copies survive a pull)</li>
