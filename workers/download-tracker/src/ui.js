...
.donate-pair{display:flex;flex-wrap:wrap;gap:12px;align-items:flex-start;margin:0 0 4px}
.donate-addr{display:block;flex:1 1 160px;min-width:0;word-break:break-all;font-size:13px;line-height:1.45;color:var(--ink);background:#16130f;padding:10px 12px;border-radius:10px;border:1px solid var(--line)}
