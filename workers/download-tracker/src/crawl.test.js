...
test("Worker SEO documents are 200 with long public cache and never empty for Googlebot", async () => {
  ...
  for (const path of ["/robots.txt", "/llms.txt", "/cite.json", "/lockset.json", "/ai.txt", "/humans.txt", "/sitemap-index.xml", "/person.jsonld", "/identity.jsonld", "/graph.jsonld", "/who-is-aziel-eliab.txt", "/who-is", "/who", "/.well-known/aziel.json", "/.well-known/person.jsonld"]) {
