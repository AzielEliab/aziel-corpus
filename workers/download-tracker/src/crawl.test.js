...
test("robots.txt allows research surfaces and major AI bots", () => {
  ...
  for (const path of ["/ai.txt", "/how-its-scored", "/humans.txt", "/software", "/donate", "/runtime", "/runtime/v1/uses", "/survival", "/v1/survival", "/runtime/survival", "/AzielEliab", "/aboutme", "/person.jsonld", "/identity.jsonld", "/graph.jsonld", "/who-is-aziel-eliab.txt", "/who-is", "/who", "/search", "/.well-known/aziel.json", "/.well-known/person.jsonld", "/shelves", "/cold-copy"]) {
...
test("cite.json, llms.txt, ai.txt, and humans.txt carry identity and hubs", () => {
  ...
  assert.equal(cite.runtime_launch.fielded_100, false);
