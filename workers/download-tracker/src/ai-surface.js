...
export const AZCORPUS = Object.freeze({
  ...
  website: Object.freeze({
    routes: Object.freeze(["/", "/search", "/corpus", "/upload", "/#upload-anonymous"]),
    browse: "/corpus",
    search: "/",
    upload_html: "/upload",
  ...
  upload: Object.freeze({
    ...
    token_in_git: false,
    note: "Public/anonymous writes stay Corpus-only (Lamb Lens). JSON ingest needs a session; GET/POST /upload and homepage POST /ingest may file as guest.",
  }),
...
export function aiSurfaceLlmsBlock() {
  return [
    ...
    "- Human guest HTML: POST " + HOST + "/upload (Corpus-only / Lamb Lens). Homepage POST /ingest remains.",
