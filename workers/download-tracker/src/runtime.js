...
function openapi() {
  return {
    ...
    paths: {
      ...
      "/person.jsonld": { get: { summary: "AZindex Person JSON-LD. @id is always https://www.azieleliab.com/#aziel.", operationId: "personJsonLd" } },
      "/identity.jsonld": { get: { summary: "AZindex identity JSON-LD. Same Person document as /person.jsonld.", operationId: "identityJsonLd" } },
      "/graph.jsonld": { get: { summary: "AZindex graph: Person, Who-is + product FAQs, WebSite publisher, library role, stats tether. Not scripture concordance entries.", operationId: "graphJsonLd" } },
      "/who-is-aziel-eliab.txt": { get: { summary: "Verbatim Who is Aziel Eliab answer from the identity lock.", operationId: "whoIsAzielEliab" } },
      "/who-is": { get: { summary: "Alias of /who-is-aziel-eliab.txt. Software publisher Aziel Eliab; Aziel Digital Library on this site. Not scripture concordance entries.", operationId: "whoIs" } },
