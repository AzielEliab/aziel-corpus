...
function openapi() {
  return {
    ...
    paths: {
      ...
      "/shelves": { get: { summary: "COLD-MULTI-SHELF-1.0 honest registry. Plane B=alt forge/archive SLOT. Zenodo tip-pack refused CNS-ZENODO-IP-BAN. doi null. 5 surfaces / 2 family radii, 1 independent live. No invented CIDs. Not AZ-GEN live ICANN publish.", operationId: "coldShelves" } },
