 ...
 * Honest leftover-bytes unredact after spectrallock#12 + aziel-runtime#137.
 * Leftover container bytes = honest recover. Opaque empty = SL-UNREDACT-OPAQUE.
 * Never invent letters. locate / lift / recover / refuse. Heatmap ≠ transcript.
 * Unredact is product Worker /v1/unredact — not a FragGate door op.
 * Corpus OCR does not unredact by guessing.
...
/** Hasher digest from aziel-runtime#137. Do not invent. */
...
export const SPECTRALLOCK_PRODUCT_PR = "https://github.com/AzielEliab/spectrallock/pull/12";

/** Catalog LIVE_OPS only. Do not invent unredact / locate / lift / recover as door ops. */
...
/** Worker SSoT one_line after aziel-runtime#137. */
...
export const SPECTRALLOCK_OCR_NOTE =
  ...
  + "Corpus OCR does not unredact by guessing. Worker: " + SPECTRALLOCK_UNREDACT
  + ". Unredact is not a FragGate door op.";
...
export const SPECTRALLOCK_NOTE =
  ...
  + "Never invent letters. locate / lift / recover / refuse. Heatmap ≠ transcript. "
  + "Worker " + SPECTRALLOCK_UNREDACT + ". Unredact is not a FragGate door op. "
  + "Catalog entry ships on aziel-runtime GET /v1/software (post #137); this library Softwares tab refreshes from that Worker SSoT. "
  + "Corpus OCR does not unredact by guessing.";
...
export const SPECTRALLOCK = Object.freeze({
  ...
  how_to_cite:
    ...
    + " leftover-bytes recover honest; opaque refuse SL-UNREDACT-OPAQUE.",
});
...
export function spectrallockLlmsBlock(host = HOST) {
  ...
  return [
    ...
    "Unredact / locate / lift / recover stay on the product Worker — not a FragGate door op. Do not invent door ops.",
    "Catalog LIVE_OPS: health, modes, targets, overlay, verify, doctor, skill. Stubs: spectrometer, forensic, invent_mark.",
    "Corpus OCR may mix advisory SpectralLock lenses. Corpus OCR does not unredact by guessing.",
    "Catalog card is Worker SSoT (GET /v1/software after aziel-runtime#137). Not a hardcoded extras card.",
    ...
    "- Product PR: " + SPECTRALLOCK_PRODUCT_PR,
