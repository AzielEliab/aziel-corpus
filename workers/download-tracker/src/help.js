...
export function howToReadScoresTxt() {
  return header("How to read scores")
    ...
    + "## Triad (always)\n"
    + "Every scored record publishes a triad first. TRIAD_V3 public combined is the 36-cycle mean: mean of all ordered pairings factor_i × factor_j among applicable factors of physics, linguistics, bayesian, truth_formula, CLCE, SPRE (36 when all six apply). geometric_mean_applicable of SPRE/CLCE/PLR is stored beside it. Display is round(combined × 100) and is never written back into combined. triad_raw freezes to the content SHA-256 at first REVIEW_SCORE. API: " + HOST + "/v1/review?record_id=\n\n"
