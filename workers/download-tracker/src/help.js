...
export function howToReadScoresTxt() {
  return header("How to read scores")
    ...
    + "- PhysLing — physics coherence mixed with linguistic neutrality. Applies when the document makes physics-evaluable or measurement claims, or is energy/engineering (or hardware with physical language). Philosophy, software, and design stay on SPRE, CLCE, and the triad unless they make those claims.\n\n"
...
export function helpUploadsTxt() {
  return header("Aziel Digital Library — uploads")
    ...
    + "SPRE, CLCE, and PhysLing are published when they apply to the filed concept.\n"
