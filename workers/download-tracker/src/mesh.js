...
export const CROSS_NETWORK_SURVIVAL = Object.freeze({
  ...
  note:
    ...
    + "Executable shelves: COLD-MULTI-SHELF-1.0 planes A/B/C (GET /shelves). Plane A = one CF/GitHub tunnel (5 surfaces / 2 family radii); B = alt independent forge/archive tip-pack SLOT; Zenodo refused CNS-ZENODO-IP-BAN; C = USB airgap SLOT. "
...
export const MESH_NOTE =
  ...
  + "Cold multi-shelf (COLD-MULTI-SHELF-1.0): planes A/B/C — A = one CF/GitHub tunnel (5 published surfaces / 2 family radii, not 5 shelves); B = alt independent forge/archive tip-pack SLOT; Zenodo refused CNS-ZENODO-IP-BAN; C = USB airgap SLOT. Executable export/verify + honest live|slot|refused registry on GET /shelves. "
