...
test("runtime manifest and skill cite the library /runtime root", () => {
  ...
  assert.equal(man.launch.fielded_100, undefined);
  ...
  assert.equal(man.vpn.wireguard, "SLOT");
  assert.equal(man.channel_plane.worker_hardware, false);
